...
class bdetails4 extends StatelessWidget {
  @override
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            radius: 70,
                            backgroundImage:
                                AssetImage('assets/icons/babysitter4.jpeg'),
                          ),
                          InkWell(
                            child: CircleAvatar(
                              radius: 30,
              ...
              Padding(
                padding: const EdgeInsets.only(left: 10, right: 10, top: 10),
                child: Text(
                  'Me chamo Karen e ainda sou estudante. Amo crianças e posso trabalhar no período da tarde.',
