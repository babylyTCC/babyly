...
import 'package:babyly/models/user_model.dart';
...
class RegistrationScreenBabysitter extends StatefulWidget {
  ...
  @override
  State<RegistrationScreenBabysitter> createState() =>
      _RegistrationScreenBabysitterState();
}

class _RegistrationScreenBabysitterState
    extends State<RegistrationScreenBabysitter> {
  ...
  signUp(String email, String passoword) async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        if (babysitters != null) {
          babysitters.add(firstNameEditingController.text);

          // Atualize a lista na outra tela
          Navigator.pop(context, babysitters);
        }
